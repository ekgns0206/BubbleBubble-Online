...
public:
	...
	void					onFrameRender(device_context& dc, sprite* sprite, int x, int y, bool rotateVertical = false);
};
...
public:
	...
	void					onFrameRender(device_context& dc, int x, int y, bool rotateVertical = false);
};
